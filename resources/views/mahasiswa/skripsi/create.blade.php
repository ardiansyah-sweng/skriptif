    ...
    <div class="wrap">
      ...
      <form action="{{ route('student.skripsi.store') }}" method="POST">
        ...
        <div class="card">
          ...
          <div class="form-group">
            <label for="suggestion_supervisor">Preferred Advisor</label>
            <select id="suggestion_supervisor" name="suggestion_supervisor" required>
            ...
            <span class="form-hint">
              This is only a proposal. The final decision rests with the department.
            </span>
          </div>
