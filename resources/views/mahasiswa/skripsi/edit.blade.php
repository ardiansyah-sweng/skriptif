...
<head>
    ...
    <title>Edit Skripsi — Sistem Skripsi</title>
...
<body>
    <div class="wrap">
        <div class="page-head">
            <div>
                <div class="crumb">
                    ...
                    <i class="ti ti-chevron-right" style="font-size:11px"></i>
                    <span>Edit Skripsi</span>
                </div>
                <h1>Edit Pengajuan Skripsi</h1>
                <p>Perbaiki pengajuan skripsi kamu</p>
            </div>
        </div>
        ...
        <div class="alert alert-danger">
            ...
            <div>
                <strong>Alasan ditolak sebelumnya:</strong><br>
        ...
        <form action="#" method="POST">
            ...
            <div class="card">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="title" name="title" value="Implementasi Machine Learning untuk Deteksi Spam">
                </div>

                <div class="form-group">
                    <label for="description">Deskripsi Singkat</label>
                    <textarea id="description" name="description" rows="4">Penerapan algoritma Naive Bayes pada klasifikasi email untuk mendeteksi pesan spam secara otomatis dengan tingkat akurasi tinggi.</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="suggestion_supervisor" name="suggestion_supervisor">
                        ...
                        <option value="1" selected>Dr. Ardiansyah, S.T., M.Cs.</option>
                ...
                <div id="courses-wrap">
                    <div class="course-row">
                        <select name="courses[0][name]">
                            ...
                            <option value="Kecerdasan Buatan" selected>Kecerdasan Buatan</option>
                    ...
                    <div class="course-row">
                        <select name="courses[1][name]">
                            <option value="">Pilih mata kuliah</option>
                            <option value="Pemrograman Web">Pemrograman Web</option>
                            <option value="Basis Data Lanjut" selected>Basis Data Lanjut</option>
                            <option value="Kecerdasan Buatan">Kecerdasan Buatan</option>
                            <option value="Rekayasa Perangkat Lunak">Rekayasa Perangkat Lunak</option>
                            <option value="Jaringan Komputer">Jaringan Komputer</option>
                        </select>
                        <select name="courses[1][grade]" class="grade">
                    ...
                    <div class="course-row">
                        ...
                        <select name="courses[2][grade]" class="grade">
                            <option value="A" selected>A</option>
                            <option value="B">B</option>
                            <option value="C">C</option>
                            <option value="D">D</option>
            ...
            <div style="display:flex;gap:8px;">
                <a href="/mahasiswa/skripsi/2" class="btn-secondary">Batal</a>
                <button type="submit" class="btn-primary">
                    <i class="ti ti-send"></i> Ajukan Ulang
                </button>
            </div>
        </form>
    </div>
