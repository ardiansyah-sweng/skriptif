...
@section('content')
    ...
    <div class="crumb mb-3" style="font-size:12px;color:#94a3b8;display:flex;align-items:center;gap:6px;">
    ...
    <div class="content-card">
        <form action="{{ route('lecturers.update', $lecturer->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="lecturer_id" name="lecturer_id" class="form-control" value="{{ old('lecturer_id', $lecturer->lecturer_id) }}" placeholder="Contoh: LCT001">
                <div class="form-hint">Nomor identitas dosen</div>
            </div>

            <div class="mb-4">
                <label for="name" class="form-label-custom">Nama Lengkap</label>
                <input type="text" id="name" name="name" class="form-control" value="{{ old('name', $lecturer->name) }}" placeholder="Contoh: Prof. Dr. Ahmad" autofocus>
                <div class="form-hint">Nama lengkap beserta gelar</div>
            </div>

            <div class="mb-4">
                <label for="email" class="form-label-custom">Email</label>
                <input type="email" id="email" name="email" class="form-control" value="{{ old('email', $lecturer->email) }}" placeholder="Contoh: dosen@uad.ac.id">
                <div class="form-hint">Alamat email aktif</div>
            </div>

            <div class="mb-4">
                <label for="expertise" class="form-label-custom">Keahlian</label>
                <input type="text" id="expertise" name="expertise" class="form-control" value="{{ old('expertise', $lecturer->expertise) }}" placeholder="Contoh: Machine Learning, Data Mining">
            ...
            <div class="mb-4">
                ...
                <input type="number" id="max_supervisors" name="max_supervisors" class="form-control" value="{{ old('max_supervisors', $lecturer->max_supervisors ?? 3) }}" min="1" placeholder="Contoh: 3">
