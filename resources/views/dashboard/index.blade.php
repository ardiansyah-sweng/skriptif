...
<div class="mb-5">
    ...
    <p class="text-muted">Selamat datang kembali di Sistem Informasi Skripsi.</p>
</div>
    ...
    <div class="col-md-4">
        <div class="card stat-card">
            <div class="card-body">
                ...
                @if($skripsi)
                    <span class="badge bg-warning">{{ ucfirst($skripsi->status) }}</span>
                @else
...
<div class="row">
    <div class="col-lg-4">
        <div class="card mb-4">
            <div class="card-body text-center">
                ...
                <p><strong>Status</strong><br>{{ ucfirst($student->status ?? '-') }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-8">
        <div class="card mb-4">
            <div class="card-header bg-primary text-white">Informasi Skripsi</div>
            <div class="card-body">
                @if($skripsi)
                    <table class="table">
                        <tr>
                        ...
                        <tr>
                            <th>Status</th>
                            <td><span class="badge bg-warning">{{ ucfirst($skripsi->status) }}</span></td>
                        </tr>
                        <tr>
                ...
                @else
                    <div class="alert alert-info">Belum ada pengajuan skripsi.</div>
                @endif
            </div>
        </div>

        <div class="card">
            <div class="card-header bg-success text-white">Aksi Cepat</div>
            <div class="card-body">
                <a href="{{ route('student.skripsi.create') }}" class="btn btn-primary">
                    <i class="fa-solid fa-file-circle-plus"></i> Ajukan Skripsi
                </a>
                <a href="{{ route('student.skripsi.history') }}" class="btn btn-outline-secondary">
