...
@section('title', 'Evaluasi Skripsi')

@push('styles')
<style>
    .wrap-eval { max-width: 1100px; margin: 0 auto; }
    ...
    .table-eval { width: 100%; border-collapse: collapse; font-size: 13px; margin: 0; }
    .table-eval thead { background: #f9fafb; }
    .table-eval thead th {
        padding: 10px 16px;
        font-size: 11px;
        font-weight: 500;
    ...
    .table-eval tbody tr { border-bottom: 0.5px solid #f0f0f0; transition: background .1s; }
    .table-eval tbody tr:last-child { border-bottom: none; }
    .table-eval tbody tr:hover { background: #f9fafb; }
    .table-eval tbody td { padding: 13px 16px; vertical-align: middle; }
...
<div class="wrap-eval">
    <div class="page-head">
        ...
        <a href="{{ route('evaluations.create') }}" class="btn-primary-custom">
