...
@section('content')
    <div class="wrap">
        <div class="page-head">
            <div>
                <div class="crumb">
                    ...
                    <a href="{{ route('elective-courses.index') }}" style="color:#9ca3af;text-decoration:none">Mata Kuliah
                        Pilihan</a>
                    <i class="ti ti-chevron-right" style="font-size:11px"></i>
                    <span>Tambah</span>
                </div>
                <h1>Tambah Mata Kuliah</h1>
                <p>Tambahkan mata kuliah pilihan baru</p>
            </div>
        ...
        <div class="card">
            <form action="{{ route('elective-courses.store') }}" method="POST">
                @csrf
                <div class="form-group">
                    <label for="courses">Nama Mata Kuliah</label>
                    <input type="text" id="courses" name="courses" value="{{ old('courses') }}"
                        placeholder="Contoh: Pemrograman Mobile" autofocus>
                    <span class="hint">Masukkan nama mata kuliah pilihan</span>
                    @error('courses')
